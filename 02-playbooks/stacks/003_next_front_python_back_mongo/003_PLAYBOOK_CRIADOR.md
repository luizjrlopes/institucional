...
Este playbook define o **processo completo de criação inicial** de um projeto Next.js Front (Next) + Python Back (FastAPI/Mongo).
...
- [MAPA_INSTITUCIONAL_CENTRAL.md](../../00-mapas_e_fluxos/MAPA_INSTITUCIONAL_CENTRAL.md)
- [DOSSIE_REGRAS_DE_CRIACAO.md](../../01-identidades/estrutura_base/003_next_front_python_back_mongo/DOSSIE_REGRAS_DE_CRIACAO.md)
- [DOSSIE_NEXT_FRONTEND.md](../../01-identidades/estrutura_base/003_next_front_python_back_mongo/DOSSIE_NEXT_FRONTEND.md)
- [DOSSIE_NEXT_BACKEND.md](../../01-identidades/estrutura_base/003_next_front_python_back_mongo/DOSSIE_NEXT_BACKEND.md)
- Snippets Institucionais (`05a-biblioteca-exemplos`)
- Referências de Interface (`05b-referencias-interface`)
...
- Configurar frontend e backend separados
