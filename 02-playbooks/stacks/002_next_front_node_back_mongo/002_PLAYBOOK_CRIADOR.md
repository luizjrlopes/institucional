...
Este playbook define o **processo completo de criação inicial** de um projeto Next.js Front (Next) + Node.js Back (Express/Mongo).
...
- [DOSSIE_REGRAS_DE_CRIACAO.md](../../01-identidades/estrutura_base/002_next_front_node_back_mongo/DOSSIE_REGRAS_DE_CRIACAO.md)
- [DOSSIE_NEXT_FRONTEND.md](../../01-identidades/estrutura_base/002_next_front_node_back_mongo/DOSSIE_NEXT_FRONTEND.md)
- [DOSSIE_NEXT_BACKEND.md](../../01-identidades/estrutura_base/002_next_front_node_back_mongo/DOSSIE_NEXT_BACKEND.md)
