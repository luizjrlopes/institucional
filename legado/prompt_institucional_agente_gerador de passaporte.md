...
v1.0 — Prompt Oficial do Agente Gerador de Passaporte
...
As referências (HTML/imagens) não têm autoridade arquitetural.
Elas são insumo, não regra.
...
1. Contratos Técnicos por Página
