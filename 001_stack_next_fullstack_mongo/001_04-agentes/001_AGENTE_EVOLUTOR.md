...
- [Referências Visuais](../referencias-etapa-mock/)
...
Toda evolução implementada pelo AGENTE_EVOLUTOR ocorre exclusivamente dentro da **ETAPA 4** do [FLUXO_ORQUESTRADOR](../../mapas_e_fluxos_centrais/FLUXO_ORQUESTRADOR_CENTRAL.md). O `FLUXO_ORQUESTRADOR` é a autoridade operacional que determina quando a Evolução pode iniciar, pausar ou ser bloqueada.
