...
- [Referências Etapa MOC](../../../05-referencias/05b-exemplos-etapa-mock/)
...
- Existe a pasta oficial de referências: [`05-referencias/05b-exemplos-etapa-mock/`](../../../05-referencias/05b-exemplos-etapa-mock/) contendo:
...
1. [Dossiê Institucional — Regras de Criação da stack](../../../01-identidades/estrutura_base/002_next_front_node_back_mongo/DOSSIE_REGRAS_DE_CRIACAO.md)
2. [Dossiê Institucional — Backend](../../../01-identidades/estrutura_base/002_next_front_node_back_mongo/DOSSIE_NEXT_BACKEND.md)
3. [Dossiê Institucional — Frontend](../../../01-identidades/estrutura_base/002_next_front_node_back_mongo/DOSSIE_NEXT_FRONTEND.md)
...
- Caminho da pasta de referências: [`05-referencias/05b-exemplos-etapa-mock/`](../../../05-referencias/05b-exemplos-etapa-mock/)
...
- Gerar o [PASSAPORTE DA APLICAÇÃO](../../../03-passaporte/PASSAPORTE_DA_APLICACAO.md) completo
