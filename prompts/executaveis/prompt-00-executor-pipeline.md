...
Este prompt representa o papel do Executor de Pipeline (humano ou agente automatizado). Sua execução garante que os passos do PLAYBOOK_PIPELINE sejam acionados em ordem e que o registro final seja gerado em `historico/pipelines/`.
...
5. Gerar registro completo em `historico/pipelines/` seguindo o template do PLAYBOOK_PIPELINE
...
- `PIPELINE-YYYYMMDD-HHMM-{scope}/00-resumo.md` e demais arquivos de etapa dentro do diretório do pipeline em `historico/pipelines/`.
