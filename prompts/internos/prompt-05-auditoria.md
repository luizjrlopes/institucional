...
## ✍️ Autorização de Escrita em `historico/`

Somente o `AGENTE_AUDITOR` ou instâncias autorizadas por decisão formal podem registrar entradas em `historico/auditorias.md`.
